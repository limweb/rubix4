    ...
    return (
      <div id='homepage-container'>
        ...
        <Hero>
          ...
          <HeroHeader2>{"Embrace React "}<sup><small><Label className='bg-deepred fg-white'>v15.1.0</Label></small></sup></HeroHeader2>
          <Grid>
            <Row>
                ...
                <Col sm={12}>
                  ...
                  <Tab.Content animation={false}>
                    ...
                    <Tab.Pane eventKey="nodejs">
                      <ul>
                        <li><strong>Isomorphic/Universal:</strong> Server-side rendering enabled.</li>
                        <li>Deployment guides for <strong>DigitalOcean</strong>.</li>
                        <li>Ability to create <strong>distributables</strong> for integrations not provided.</li>
                        <li>Authentication with <strong>Auth0</strong></li>
                      </ul>
                    </Tab.Pane>
                  </Tab.Content>
                </Col>

...
class TabsBasic extends React.Component {
  ...
  render() {
    return (
      <PanelTabContainer id='tabs-basic' controlStyles='bg-lightgreen fg-white' defaultActiveKey="home">
...
class TabsInline extends React.Component {
  ...
  render() {
    return (
      <PanelTabContainer id='tabs-inline' controlStyles='bg-lightpurple fg-white' defaultActiveKey="home">
      ...
      <div>
        ...
        <Row>
          <Col sm={6} className='text-left'>
            ...
            <Pager>
              <PageItem previous disabled href="#">&larr; Previous</PageItem>
            </Pager>
          </Col>
          <Col sm={6} className='text-right'>
            <h3>Pager (next disabled)</h3>
            <Pager>
              <PageItem next disabled href="#">Next &rarr;</PageItem>
            </Pager>
          </Col>
        </Row>
      </div>

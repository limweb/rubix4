          ...
          <tbody>
            <tr>
              <td style={{padding: '12.5px 25px'}}>
                <Progress collapseBottom label='Karl Pohl' value={57} color='#FA824F' min={0} max={100} />
              </td>
            ...
            <tr>
              <td style={{padding: '12.5px 25px'}}>
                <Progress collapseBottom label='Gamze Erdoğan' value={35} color='#EBA068' min={0} max={100} />
              </td>
              <td style={{padding: '12.5px 25px'}} className='text-right'>
                <Label>33</Label>
              </td>
            ...
            <tr>
              <td style={{padding: '12.5px 25px'}}>
                <Progress collapseBottom label='Leyla Cəlilli' value={30} color='#FFC497' fgColor='#B86A2D' min={0} max={100} />
              </td>
              <td style={{padding: '12.5px 25px'}} className='text-right'>
                <Label>23</Label>
              </td>
            ...
            <tr>
              <td style={{padding: '12.5px 25px'}}>
                <Progress collapseBottom label='Nadir Üzeyirzadə' value={41} color='#FFC9A0' fgColor='#B86A2D' min={0} max={100} />
              </td>
              <td style={{padding: '12.5px 25px'}} className='text-right'>
                <Label>11</Label>
              </td>
            ...
            <tr>
              <td style={{padding: '12.5px 25px'}}>
                <Progress collapseBottom label='Anna Sanchez' value={66} color='#FFD3B1' fgColor='#B86A2D' min={0} max={100} />
              </td>
              <td style={{padding: '12.5px 25px'}} className='text-right'>
                <Label>7</Label>
              </td>

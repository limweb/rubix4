...
import { State } from 'react-bootstrap/lib/styleMaps';
import {
  bsStyles, bsClass, getClassSet, prefix,
} from 'react-bootstrap/lib/utils/bootstrapUtils';
import deprecationWarning from 'react-bootstrap/lib/utils/deprecationWarning';
...
class ProgressBar extends React.Component {
  ...
  renderProgressBar() {
    let { className, label, now, min, max, style, color, ...props } = this.props;
    ...
    return (
      <div
        className={classes}
        role="progressbar"
        style={{ width: percentage + '%', backgroundColor: color, ...style }}
